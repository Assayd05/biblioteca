...
export const Historial = () => {
  ...
  // Obtener la matrícula del usuario (ajusta según tu sistema)
  const matricula = localStorage.getItem('matricula'); // O usa tu método para obtener la matrícula
          ...
          loans.map((loan) => (
            <div key={loan.id} className="historial-item">
              <div className="info-left">
                <img src={loan.image || '/default-image.jpg'} alt={loan.title || 'Libro'} className="historial-img" />
              </div>
